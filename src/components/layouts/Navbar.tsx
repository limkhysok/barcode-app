      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
          ...
          <div>
            ...
            <p className="text-[9px] font-medium tracking-[0.15em] uppercase leading-none mt-0.5"
              style={{ color: "#FA4900" }}>
              Spare Parts
            </p>
          </div>
        ...
        <div className="hidden md:flex items-center gap-1 flex-1 justify-center">
          {navLinks.map(({ label, href }) => (
            <Link
              key={label}
              href={href}
              className="relative px-4 py-2 rounded-lg text-xs font-semibold tracking-widest uppercase
                text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-all duration-200 group"
            >
              {label}
              <span
        ...
        <div className="hidden md:flex items-center gap-2 shrink-0">
          ...
          <Link
            ...
            className="flex items-center gap-2 px-5 py-2 rounded-xl text-xs font-bold
              tracking-widest uppercase text-white hover:opacity-90 active:scale-[0.97]
          ...
          {navLinks.map(({ label, href }) => (
            <Link
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold
                text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition"
            >
              {label}
            </Link>
          ))}
          <div className="pt-2 border-t border-gray-100">
            <Link
              ...
              className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl
                ...
                hover:opacity-90 active:scale-[0.98] transition shadow-sm"
              style={{ background: "linear-gradient(135deg, #FA4900, #b91c1c)" }}
            >
