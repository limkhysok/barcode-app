    ...
    <div className="space-y-3">
      ...
      <div className="hidden sm:grid grid-cols-10 gap-2 items-stretch">
        ...
        <div className="col-span-7 grid grid-cols-2 gap-2">
          {/* All Receive */}
          <div className="group bg-white border border-gray-200 rounded-md p-3.5 transition-all duration-300 hover:border-orange-500/30 hover:shadow-xl group/receive overflow-hidden flex flex-col justify-between h-full">
          ...
          {/* All Sale */}
          <div className="group bg-white border border-gray-200 rounded-md p-3.5  transition-all duration-300 hover:border-orange-500/10 hover:shadow-xl group/sale overflow-hidden flex flex-col justify-between h-full">
            <div className="flex items-center gap-4">
        ...
        <div className="col-span-3">
          <div className="group h-full bg-white border border-gray-200 rounded-md p-3.5 transition-all duration-300 hover:border-orange-500/30 hover:shadow-xl flex flex-col justify-between">
            <div className="space-y-3">
