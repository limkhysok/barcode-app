    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
      ...
      <div className="px-5 py-4 border border-black bg-white rounded-xl">
        <div className="flex items-center justify-between mb-3">
          <p className="text-[13px] font-light text-gray-700  tracking-[0.18em]">Receive</p>
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            <span className="text-[12px] font-light text-gray-600  tracking-widest">Total Count</span>
            <span className="text-sm font-black text-black tabular-nums">{receiveCount.toLocaleString()}</span>
          </div>
          <div className="border-t border-dashed border-gray-200" />
          <div className="flex items-center justify-between">
            <span className="text-[12px] font-light text-gray-600  tracking-widest">Total Money</span>
      ...
      <div className="px-5 py-4 border border-black bg-white rounded-xl">
        <div className="flex items-center justify-between mb-3">
          <p className="text-[13px] font-light text-gray-700  tracking-[0.18em]">Sale</p>
          <div className="w-7 h-7 rounded-none border border-black bg-slate-50 flex items-center justify-center text-black shrink-0">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
      ...
      <div className="px-5 py-4 border border-black bg-white rounded-xl">
        <div className="flex items-center justify-between mb-3">
          <p className="text-[13px] font-light text-gray-700  tracking-[0.18em]">Transactions</p>
          <div className="w-7 h-7 rounded-none border border-black bg-slate-50 flex items-center justify-center text-black shrink-0">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
        ...
        <div className="space-y-1.5">
          ...
          <div className="border-t border-dashed border-gray-200" />
          <div className="flex items-center justify-between">
            <span className="text-[12px] font-light text-gray-600  tracking-widest">All Types</span>
