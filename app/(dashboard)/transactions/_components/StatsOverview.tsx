...
const StatsOverview: React.FC<StatsOverviewProps> = ({ stats }) => {
  ...
  return (
    <div className="w-full">
      {/* ── Mobile Overview ── */}
      <div className="block sm:hidden rounded-md border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div className="p-4 bg-white border-b border-slate-100">
          ...
          <div className="grid grid-cols-3 gap-0">
            ...
            <div className="text-left space-y-0.5 border-l border-slate-200 pl-4">
        ...
        <div className="p-4 bg-slate-50/50">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="flex items-center p-2.5 bg-white rounded-sm border border-slate-200 shadow-sm">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[8px] font-bold text-slate-400 uppercase leading-tight">Qty: {receiveTodayQty}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center p-2.5 bg-white rounded-sm border border-slate-200 shadow-sm">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[8px] font-bold text-slate-400 uppercase leading-tight">Qty: {saleTodayQty}</p>
                </div>
              </div>
            </div>
          </div>
