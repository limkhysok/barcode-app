  ...
  return (
    <div className="px-8 py-8 space-y-8 max-w-2xl">
      ...
      <div className="flex items-center gap-5">
        ...
        <div>
          <p className="text-base font-bold text-gray-900">{user?.name || user?.username}</p>
          <p className="text-sm text-gray-400">{user?.email}</p>
          <p className="text-xs font-medium tracking-widest uppercase text-gray-300 mt-0.5">@{user?.username}</p>
        </div>
      </div>
